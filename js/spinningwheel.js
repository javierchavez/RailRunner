    ...
    // Helpers
        ...
        SpinningWheel = {
            ...
            create: function () {
                ...
                div.innerHTML = '<div id="sw-header"><div id="sw-cancel">Change Direction</' + 'div><div id="sw-done">Done</' + 'div></' + 'div><div id="sw-slots-wrapper"><div id="sw-slots"></' + 'div></' + 'div><div id="sw-frame"></' + 'div>';
